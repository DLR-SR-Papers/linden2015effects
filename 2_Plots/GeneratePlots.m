...
useInternalDLRToolboxes = false; % set to false if internal DLR toolboxes are not available. This only effects grahical effects.
...
elseif exportFigures
    saveas(gcf, fullfile(exportdirectory,'SmallSystem.png'))
end
...
elseif exportFigures
    saveas(gcf, fullfile(exportdirectory,'BigSystem.png'))
end
...
elseif exportFigures
    saveas(gcf, fullfile(exportdirectory,'ErrorComparison.png'))
end
...
elseif exportFigures
    saveas(gcf, fullfile(exportdirectory,'SignalNoise.png'))
end
