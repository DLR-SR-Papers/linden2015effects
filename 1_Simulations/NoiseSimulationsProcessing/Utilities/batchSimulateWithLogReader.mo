within NoiseSimulationsProcessing.Utilities;
function batchSimulateWithLogReader

  input String modelName = "NoiseSimulationsProcessing.Examples.NoInterplolationIntegratorSampleFree";
...
algorithm
  ...
  for i in 1:size(Tolerances,1) loop
    ...
    logValues[:, i] := NoiseSimulationsProcessing.Utilities.readLogFile(
      "dslog.txt", getSimulationProperties);
